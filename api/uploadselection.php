...
<div id="wrapper">
    <header class="navbar">
        <div class="logo">
            <img src="https://www.dropbox.com/scl/fi/oo9zuxjgx2dzws72biodk/mdx_logo.png?rlkey=37lcn6yg9aoqjynlelncfsl6e&st=wym5ccps&raw=1" alt="Mangasay Data Exchange Logo">
        </div>
        ...
        <nav class="nav-links">
            ...
            <div class="profile-icon">
                <img src="https://www.dropbox.com/scl/fi/qluw1qll9bauz91379zhl/avatarIconunknown.jpg?rlkey=jhrxtz3pl41wsfayiwce6gqtl&st=pwpbjimn&raw=1" alt="Profile">
            </div>
        </nav>
    </header>
    ...
    <div class="container">
        ...
        <form id="uploadForm" action="upload.php" method="post" enctype="multipart/form-data">
            <label for="fileToUpload" class="drop-area">
                <img src="https://www.dropbox.com/scl/fi/m8bozr4tune5nqpbp16vi/upload_button.png?rlkey=3jldc29x7aqz0tr5etqlc2tb9&st=fkoel2eb&raw=1" alt="Upload Icon">
